...
| D14 | **Cross-links to `fabiabox.com`:** header logo → main site; footer → research + investor deck; FAQ section links to `/research.html`. | Keeps shop as conversion surface while directing explorers to deeper content. | Start implementation now? |
